...
@XmlRootElement(name = "snsoauth_profile",namespace="http://www.robotservices.org/schemas/ApproachingNotification_profile_end_profile")
public class ApproachingNotification_profile_end_profile {
